...
def load_rows():
    ...
    return detail_rows, summary_rows, stats, total_rows, with_groups


def build_workbook(detail_rows, summary_rows, stats, total_rows, with_groups):
    wb = Workbook()
    ...
    ws_stats.append(["success_rows", total_rows])
...
def main():
    ...
    detail_rows, summary_rows, stats, total_rows, with_groups = load_rows()
    workbook = build_workbook(detail_rows, summary_rows, stats, total_rows, with_groups)
    workbook.save(OUTPUT_XLSX)

    print(f"输入文件: {INPUT_CSV}")
    print(f"输出文件: {OUTPUT_XLSX}")
    print(f"成功设备数: {total_rows}")
